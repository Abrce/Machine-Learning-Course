...
The choosen model is Boosted trees.
...
Using the original data from the accelerometer, it is possible to predict the class of exercise on the 6 participants.